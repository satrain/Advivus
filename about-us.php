...
<header class="header header--small header--about">
    <div class="container">
        <div class="header__wrap">
            <div class="header__item">
                <h3 class="heading-gold">
                    Discover the Advivus Journey
                </h3>
                ...
                <p class="header-paragraph">
                    The Tale of the Game-Changing Affiliate Network Which is Optimizing Your Digital Success!
                </p>
            </div>
        </div>
    </div>
...
<main>
    <section class="introducing">
        <div class="container-fluid-1">
            <div class="introducing__wrap">
                <h2 class="heading-secondary top_border">
                    Introducing Advivus
                </h2>

                <p class="paragraph-about-small">
    ...
    <section class="built">
        <div class="container">
            <div class="built__wrap">
                <h2 class="heading-secondary top_border">
                    A Company Built on Transparency, Fairness, and Quality
                </h2>
                ...
                <div class="built__grid built__grid--reverse">
                    <div class="built__text">
                        <div class="built__text__inner">
                            <h5>
                                Our Standards
                ...
                <div class="built__grid">
                    ...
                    <div class="built__text">
                        <div class="built__text__inner">
                            ...
                            <h4>
                                Utilizing the Power of Positive Margins
                            </h4>
    ...
    <section class="reach">
        <div class="container">
            <div class="reach__wrap">
                ...
                <p>
                    Let's explore how Advivus can redefine your digital journey and help you achieve your business goals. Welcome to the future of affiliate marketing - welcome to Advivus!
                </p>
